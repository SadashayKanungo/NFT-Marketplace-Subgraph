...
export class NFT__TokenExtraInfosResult {
  value0: Address;
  value1: string;
  value2: BigInt;
...
export class NFT extends ethereum.SmartContract {
  ...
  mintItem(
    _owner: Address,
    _tokenDataURI: string,
    _metaDataURI: string,
    _royaltyPercentage: BigInt
  ): BigInt {
    let result = super.call(
      "mintItem",
      "mintItem(address,string,string,uint256):(uint256)",
      [
        ethereum.Value.fromAddress(_owner),
        ethereum.Value.fromString(_tokenDataURI),
  ...
  getMetaDataURI(_tokenId: BigInt): string {
    let result = super.call(
      "getMetaDataURI",
  ...
  try_getMetaDataURI(_tokenId: BigInt): ethereum.CallResult<string> {
    let result = super.tryCall(
      "getMetaDataURI",
      "getMetaDataURI(uint256):(string)",
      [ethereum.Value.fromUnsignedBigInt(_tokenId)]
  ...
  getOriginalMinter(_tokenId: BigInt): Address {
    let result = super.call(
      "getOriginalMinter",
      "getOriginalMinter(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(_tokenId)]
    );
  ...
  try_getOriginalMinter(_tokenId: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getOriginalMinter",
      "getOriginalMinter(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(_tokenId)]
  ...
  getRoyaltyPercentage(_tokenId: BigInt): BigInt {
    let result = super.call(
      "getRoyaltyPercentage",
      "getRoyaltyPercentage(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(_tokenId)]
    );
  ...
  try_getRoyaltyPercentage(_tokenId: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getRoyaltyPercentage",
      "getRoyaltyPercentage(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(_tokenId)]
  ...
  isClaimed(_nftIndex: BigInt): boolean {
    let result = super.call("isClaimed", "isClaimed(uint256):(bool)", [
      ethereum.Value.fromUnsignedBigInt(_nftIndex)
    ]);

    return result[0].toBoolean();
  }

  try_isClaimed(_nftIndex: BigInt): ethereum.CallResult<boolean> {
  ...
  nftClaimBitMask(param0: BigInt): BigInt {
    let result = super.call(
      "nftClaimBitMask",
      "nftClaimBitMask(uint256):(uint256)",
  ...
  try_nftClaimBitMask(param0: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "nftClaimBitMask",
      "nftClaimBitMask(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  TokenExtraInfos(param0: BigInt): NFT__TokenExtraInfosResult {
    let result = super.call(
      "TokenExtraInfos",
      "TokenExtraInfos(uint256):(address,string,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new NFT__TokenExtraInfosResult(
      result[0].toAddress(),
      result[1].toString(),
      result[2].toBigInt()
    );
  ...
  try_TokenExtraInfos(
    param0: BigInt
  ): ethereum.CallResult<NFT__TokenExtraInfosResult> {
    let result = super.tryCall(
      "TokenExtraInfos",
      "TokenExtraInfos(uint256):(address,string,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new NFT__TokenExtraInfosResult(
        value[0].toAddress(),
        value[1].toString(),
        value[2].toBigInt()
      )
